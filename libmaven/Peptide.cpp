...
void Peptide::defaultTables() {
  ...
  (*AAMonoisotopicImmoniumTable)["D"][0] = 88.03986;
  (*AAMonoisotopicImmoniumTable)["D"][1] = 0.0; 
  (*AAMonoisotopicImmoniumTable)["E"] = new double[2];
  (*AAMonoisotopicImmoniumTable)["E"][0] = 102.05550;
  ...
  (*AAMonoisotopicImmoniumTable)["N"][0] = 87.05584;
...
bool Peptide::parseMspModStr(string mspModStr, bool add) {
  ...
  string m;
  while ((m = FragmentIon::nextToken(mspModStr, slashPos + 1, slashPos, "/ \t\r\n")) != "") {
...
string FragmentIon::nextToken(string s, string::size_type from, string::size_type& tokenEnd, const char* delim, const char* skipover) {
