...
class MassCalculator { 
    ...
    vector<Isotope> computeIsotopes(string formula, int polarity, int maxNumProtons=INT_MAX, bool isUse13C=true, bool isUse15N=true, bool isUse34S=true, bool isUse2H=true);
